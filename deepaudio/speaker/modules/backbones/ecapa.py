#code from https://github.com/lawlict/ECAPA-TDNN/blob/master/ecapa_tdnn.py
import torch
...
class ECAPA_TDNN(nn.Module):
    def __init__(self, in_channels=80, channels=1024, embed_dim=192):
        super().__init__()
        ...
        self.linear = nn.Linear(cat_channels * 2, embed_dim)
